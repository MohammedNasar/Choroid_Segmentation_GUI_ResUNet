...
function [cib1,cob1,rang,rangc] = chSeg_corr_cib_cob(cib,cob,uinp)
% 
% uinp='100-400,550';
...
% o1=-27;o2=11;
o1=0;o2=90;
figure(1);mesh(cib); hold on; mesh(cib+cob);
% title(strcat('cib and cob surfaces before correction....',str1{6}), 'Interpreter', 'none');
title('CIB and COB surfaces before correction');
% view(o1,o2);
...
figure(2);mesh(cib);hold on; mesh(cib+cob);
% view(o1,o2);
title('CIB and COB surfaces at correction step');
...
figure(3);mesh(cib1);hold on;mesh(cib1+cob1);
% title(strcat('cib and cob surfaces before correction....',str1{6}), 'Interpreter', 'none');
title('CIB and COB surfaces after correction');
% view(o1,o2);
